...
// Build variety grid as a real DOM node (not HTML string) so SVG namespace is preserved
window.buildVarietyGrid = function(page, targetEl) {
  ...
  // Helper: build one card DOM node for a variety
  function makeCard(v, extraStyle) {
    ...
    // Top row: SVG illustration + name/badges
    var topRow = document.createElement('div');
    topRow.style.cssText = 'display:flex;align-items:center;gap:10px;';

    // SVG tulip — append as real DOM node, not HTML string
